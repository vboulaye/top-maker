...
const isTypeScript6 = typescript_1.default.version.startsWith('6');
/**
...
function getCompilerOptions({ filename, options, basePath, }) {
    ...
    const compilerOptions = {
        ...
        module: !isTypeScript6 ||
            ...
            : typescript_1.default.ModuleKind.NodeNext,
        moduleResolution: convertedCompilerOptions.moduleResolution ===
            typescript_1.default.ModuleResolutionKind.Bundler
            ? typescript_1.default.ModuleResolutionKind.Bundler
            : isTypeScript6
                ? typescript_1.default.ModuleResolutionKind.NodeNext
